...
## Step 4
**(*Optional)**
If you would like to update tailwind css, (most likely when you have to update `tailwind.config.js`), run the following command (*Make sure you have `npx` and `tailwindcss cli` installed on your machine):
```
